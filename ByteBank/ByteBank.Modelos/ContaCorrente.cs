...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente
    {
        ...
        /// </summary>
        /// <param name="agencia">Represa o valor da propriedade <see cref="Agencia" /> e deve possuir um valor maior que 0.</param>
        /// <param name="numero">Represa o valor da propriedade <see cref="Numero"/> e deve possuir um valor maior que 0.</param>
